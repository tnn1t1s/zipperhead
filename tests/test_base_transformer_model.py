...
def test_train_odd_sums():
    ...
    # Initialize model
    model = BaseTransformerModel(max_int=max_int)
    optimizer = torch.optim.Adam(model.parameters(), lr=0.001)  # Lower learning rate for transformer
    ...
    assert accuracy > 95, f"Model accuracy {accuracy:.1f}% below threshold 95%"
